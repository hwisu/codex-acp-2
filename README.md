...
Codex ACP version: `0.142.1` · ACP contract: `100%` advertised (`11/11` handlers), `80%` enabled SDK surface (`11/16`; `session/delete`, `session/fork`, and `session/resume` are not advertised; `mcp/connect` is disabled)
