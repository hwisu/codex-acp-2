...
Codex ACP 버전: `0.135.0` · ACP 계약 구현: advertised `100%` (`12/12` handler), enabled SDK surface `80%` (`12/15`; `session/delete`, `session/fork`, `session/resume`은 광고하지 않음)
...
- Codex Rust crates: [`openai/codex`](https://github.com/openai/codex/tree/rust-v0.135.0/codex-rs)
  tag `rust-v0.135.0` (`Cargo.lock` 기준 `4daceea869704f9f35e0a3949fc34711ef978a4e`)
- ACP Rust SDK: [`agent-client-protocol`](https://crates.io/crates/agent-client-protocol)
  ...
  `agent-client-protocol = 0.12.1` + `unstable`
  (`agent-client-protocol-schema = 0.13.2`, lockfile 기준)
