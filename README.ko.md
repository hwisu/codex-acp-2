...
Codex ACP 버전: `0.141.0` · ACP 계약 구현: advertised `100%` (`11/11` handler), enabled SDK surface `11/16` (`session/delete`, `session/fork`, `session/resume`은 광고하지 않음; `mcp/connect` 비활성화)
...
- Codex Rust crates: [`openai/codex`](https://github.com/openai/codex/tree/rust-v0.141.0/codex-rs)
  tag `rust-v0.141.0` (`Cargo.lock` 기준 `3fb81667d30d9d24297216ea61fbfcc4351b2aa9`)
